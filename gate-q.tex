...
\textbf{arduino file link:} \url{https://github.com/Harshith-Akella-1/gate-q/blob/main/gate-q.ino} \\[0.5em]
\textbf{latex file link:} \url{https://github.com/Harshith-Akella-1/gate-q/blob/main/gate-q.tex}
\end{tcolorbox}
